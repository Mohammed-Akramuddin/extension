...
async function enableSafeSearchRules() {
	try {
		...
		// Ensure uniqueness by removing existing rules with same IDs before adding
...
chrome.runtime.onMessage.addListener((message, _sender, sendResponse) => {
    ...
    } else if (message && message.type === 'OPEN_VERIFICATION') {
      try {
        ...
        console.error('[background] OPEN_VERIFICATION failed', e);
